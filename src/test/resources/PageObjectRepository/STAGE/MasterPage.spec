...
course_org                          xpath                   (//a[contains(@class, 'orgtitle title searchHighlightable')])[1]
course_name                         xpath                   (//a[contains(@class, 'coursetitle searchHighlightable title')])[1]
...
showcopy_btn                        xpath                   //a[contains(.,'Show Copy')]
pushtosnapshot_btn                  xpath                   //img[contains(@alt,'Copy Annotations To Snapshot')]
p2s_window                          xpath                   //div[@id='pushModal']
savetomaster_btn                    xpath                   //a[contains(.,'Save to Master')]
p2s_update_content                  xpath                   //label[contains(@for,'content')]
p2s_update_annotations              xpath                   //label[contains(@for,'annotations')]
p2s_notdisplay_options              xpath                   //ul[@class='formGroup checkList plain']/li[(contains(@style,'display:none'))]
p2s_display_options                 xpath                  //ul[@class='formGroup checkList plain']/li[not(contains(@style,'display:none'))]
=================================================================================
