...
assessment_link                      xpath             //h3[contains(@id,'Assessment')]
select_assessment_msg                xpath            .//*[@id='clhomework-grove-container']//div[@class='typeTitle']
...
lpn_unit_link_his                    xpath             //h3[@class='lpn_name']//a[contains(text(),'Unit 22')]
lpn_title_inside_unit_his            xpath             .//*[@id='lpn_toolbar']//span[@class="lpn_title"]
infographic_lpn_link_his             xpath             //h3[@class='lpn_name']//a[contains(text(),'22.1 Picturing History')]
con_narrative_lpn_link_his           xpath             //h3[@class='lpn_name']//a[contains(text(),'22.2 Cold War Crises')]
contextual_lens_lpn_link_his         xpath             //h3[@class='lpn_name']//a[contains(text(),'22.5 Why Does This Matter? American Artifacts Lens')]
essay_act_lpn_link_his               xpath             //h3[@class='lpn_name']//a[contains(text(),'22.7 Why Does This Matter? Essay Activity: Social Lens')]
history_test                         xpath             (//span[contains(text(), 'Picturing History')])[1]
...
analytics_Tab                        xpath            //a//div[contains(text(), 'Analytics')]
course_name                          xpath            //div[@role='banner']//div[contains(@class, 'ng-binding')]
============================================================================================================================================================
