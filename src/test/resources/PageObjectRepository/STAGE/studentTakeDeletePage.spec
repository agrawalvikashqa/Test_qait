...
allActivities                              xpath                   //div[contains(@class, 'ag-row-level')]//div[contains(@class, 'score') and contains(text(), '%')]
Score_activity                             xpath                   (//div[contains(@class, 'ag-row-level')]//div[contains(@class, 'score') and contains(text(), '%')])[1]
