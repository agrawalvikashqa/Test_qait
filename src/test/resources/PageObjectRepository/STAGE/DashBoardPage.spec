...
verifyLocation                       xpath           (//span[@class='ui-selectmenu-status'])[1]
addLocation                          xpath           (//a[ contains(@id,'ui-selectmenu-item') and contains(text(),'Test Folder (Do not Delete)')])
selectChapter                        xpath            //li[@role='presentation']/a 
activitycontainer                    xpath            //a[contains (text(),'Test Folder (Do not Delete)')]/ancestor::div[contains(@class,'lpn_group_expanded')]//div[@class='lpn_bookmark distinctejs_bookmark' and@title='Most Recent Activity']
nonmindtapactivity                     xpath            //h3[@class='lpn_name']/a[contains(text(),'Comprehensive Medical Terminology Review')]
