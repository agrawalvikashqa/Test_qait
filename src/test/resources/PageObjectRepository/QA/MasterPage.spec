...
editSettingsButton                  xpath                   //a[text()='${organizationsName}']//..//span//a
organizationsNames                  xpath                  //div[@class='list ui_columnlist']//ul//li/a
logoUpload_textBox                  id                      logoUpload
logoUploadButton                    id                      logoUploadButton
imagePreview                        xpath                   //img[@class='imagePreview']
 closeEditSettingsBtn                      xpath                   //a[@title='close']
logoInstitute                              xpath           //div[@class='logoInstitute']/img
 logoDeleteButton                   xpath                  //button[@class='logoDeleteButton adminButton']
=================================================================================
