 ...
 */
package com.cengage.mindtap.tests.UserRoles.courseCareRoleScenarios;
 ...
 * @author QAI
 */
public class courseCareRoleSmokeTest {
    ...
    public void start_test_session() {
        test = new TestSessionInitiator("Course Care Role Smoke Test");
