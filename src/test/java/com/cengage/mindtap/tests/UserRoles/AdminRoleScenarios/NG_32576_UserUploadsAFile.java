 ...
 * @author QAI
 */
public class NG_32576_UserUploadsAFile {
...
String CourseKey = getData("Books.organizations1.courseKey");
    ...
    public void start_test_session() {
        test = new TestSessionInitiator("Branding Logo Test");
 ...
 */
   ...
   @Test
    ...
    public void TestStep_05_LaunchCourse() {
        ...
        @Test
    public void TestStep_06_verifyUpLoadFile() {
       
       Assert.assertTrue(test.masterPage.verifyupLoadFileOnLPN());
       Reporter.log(user + "Successfully  Institute Logo Added", true);
    }
