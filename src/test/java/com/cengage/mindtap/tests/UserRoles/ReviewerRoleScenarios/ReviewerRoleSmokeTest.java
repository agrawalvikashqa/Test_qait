 ...
 */
package com.cengage.mindtap.tests.UserRoles.ReviewerRoleScenarios;
 ...
 * @author QAI
 */
public class ReviewerRoleSmokeTest {
    ...
    public void start_test_session() {
        test = new TestSessionInitiator("Reviewer Role Smoke Test");
        user = System.getProperty("user", "reviewer");
 ...
 */
   ...
   @Test
    public void TestStep_02_ClickMasterTabAndVerifyNoButtonDisplay() {
      System.out.println(bookName);
      test.masterPage.clickonMasterTab();
      Assert.assertFalse(test.masterPage.verifyRefreshButtonInMastersTab(bookName,"Refresh",user));
