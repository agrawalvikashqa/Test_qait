 ...
 */
package com.cengage.mindtap.tests.Mindapps.UserRoleScenarios.ReviewerRoleScenarios;
...
public class CreateMasterAndVerifyOnDashboardTest {
    ...
    public void TestStep_04_EditMasterBookTitle(){
        Assert.assertTrue(test.lpnPage.verifyNoeditMasterLearningPathNameOption(bookName));
        Reporter.log("Master verify No edit Master Learning PathName Option", true);
    }
