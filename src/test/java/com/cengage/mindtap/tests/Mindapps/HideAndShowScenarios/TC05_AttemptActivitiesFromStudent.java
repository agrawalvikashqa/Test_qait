...
public class TC05_AttemptActivitiesFromStudent {
    ...
    @Test
    public void TestStep_03_AttemptActivities(){
        ...
        test.DashBoardPage.launchDistinctActivity(titleHomework);
        test.AssignableActivityPage.SubmitActivity();
        test.DashBoardPage.closeLaunchedActivity(titleHomework);
    }
