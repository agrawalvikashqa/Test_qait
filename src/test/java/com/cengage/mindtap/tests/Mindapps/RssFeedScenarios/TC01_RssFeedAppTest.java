 ...
 */
package com.cengage.mindtap.tests.Mindapps.RssFeedScenarios;
...
public class TC01_RssFeedAppTest {
 ...
 @Test
   ...
   @Test
    ...
    @Test
    public void TestStep_09_AddedInlineRssActivity(){
    test.DashBoardPage.clickOnView("Unit View");
    test.RSSFeedPage.switchToReader(Reader);
    test.FramesPage.switchToMainFrame();
    test.RSSFeedPage.addInline();
    test.DashBoardPage.clickOnActivity("Inline RSS Feed");
    test.FramesPage.switchToDistinctActivityCreateFrame();
    test.RSSFeedPage.addRssFeedLPN(url, filename);
    test.RSSFeedPage.AddedInlineRssActivity(filename);
    test.RSSFeedPage.DeleteInlineActivity(filename);
    }
