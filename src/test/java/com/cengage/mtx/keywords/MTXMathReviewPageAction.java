 ...
 */
public class MTXMathReviewPageAction extends BasePageActions{
    
    public MTXMathReviewPageAction(WebDriver driver) {
        super(driver, "MTXMathReviewPage");
    } 
    String currentScore;
    String classAverage;
    
    public void verifyNextButtonisPresentforMathReview(){
        ...
        //element("next_btn").isDisplayed();
        
        System.out.println("Next Button is present at bottom");
    }
    
     public void verifyBackButtonisPresentforMathReview(){
     ...
     public void verifyCurrentScorePresentatBottomforMathReview(){
     ...
     public void verifynextButtonOnLeftPanelforMathReview(){
        element("nextNavigation_btn").isDisplayed();
        System.out.println("Next Button is present On Left navigation Panel");
    }
     
     public void verifyPreparationTabPresentforMathReview(){
        Assert.assertTrue(element("preparationTab").isDisplayed(), "Preparation tab is not present in left navigation");
