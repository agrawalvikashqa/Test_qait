 ...
 * @author amitkashyap
 */
public class TC01_InstructorStudyCenterTestFlow {
	...
	public void TestStep_02_LaunchStudyCenter () {
		// Launch StudyCenter
		Reporter.log("Test_02 : Verify Instructor is able to Launch Study Center",true);
	...
	public void TestStep_06_GeneratesPracticeQuiz() {
		...
		Reporter.log("Test_06 : Verify Instuctor Generates Practice Quiz",true);
	...
	public void TestStep_09_FinishQuiz() {
		// Finish Quiz
		Reporter.log("Test_09 : Verify Instructor is able to Finish Quiz",true);
