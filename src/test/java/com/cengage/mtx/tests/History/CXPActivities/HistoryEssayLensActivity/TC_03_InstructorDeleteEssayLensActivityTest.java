 ...
 * @author chandanjyot
 */
public class TC_03_InstructorDeleteEssayLensActivityTest {
   ...
   // @Test
    public void TestStep_02_InstructorDeleteTakeofActivity(){
        ...
        test.MTXNarrativePage.clickOnActivityLinkInGradebook(essayActivityTitle);
        test.MTXNarrativePage.clickOnDeleteTakeLink();
         test.MTXNarrativePage.clickOnConfirmButtoninGB();
    }
    
    @Test
    public void TestStep_03_deleteActivity(){
        test.MTXDashBoardPage.clickOnView("Unit View");
        test.MTXDashBoardPage.deleteDistinctActivity(essayActivityTitle);
    }
