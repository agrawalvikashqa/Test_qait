 ...
 * @author QAI
 */
public class TC01_InstructorFlowSmokeTestHistory {
	 ...
	 */
        ...
        Reporter.log("**************************************************** ", true);
        Reporter.log("**** MTX History Smoke Test Started***  ", true);
        Reporter.log("**************************************************** ", true);
    ...
    public void TestStep_01_LoginToSSOApplication() {
        Reporter.log("Test_01 : Verify Instructor logs in to the mindtap application",true);
	...
	public void TestStep_10_verifyInstructorNavigatesToUnitViewAndLaunchesUnit(){
        ...
        @Test
	public void TestStep_11_verifyInstructorLaunchesActivityTypeInfographic(){
           Reporter.log("Test_11 : Verify Instructor Launches Activity Type Infographic ",true); 
           ...
           Reporter.log("Verified that Instructor Successfully Launches and close Activity Type Infographic",true);
	...
	public void TestStep_12_verifyInstructorLaunchesActivityTypeConceptualNarrative(){
        ...
        @Test
	public void TestStep_13_verifyInstructorLaunchesActivityTypeContextualLens(){
           Reporter.log("Test_13 : Verify Instructor Launches Activity Type Contextual Lens",true); 
        ...
        @Test
	public void TestStep_14_verifyInstructorLaunchesActivityTypeEssay(){
           Reporter.log("Test_14 : Verify Instructor Launches Activity Type Essay",true); 
        ...
        @Test
	public void TestStep_15_verifyInstructorLaunchesStudyGuide(){
           Reporter.log("Test_15 : Verify Instructor Launches Study Guide ",true); 
        ...
        @Test
	public void TestStep_16_verifyInstructorSetsAndClearsDueDateFromDateManager(){
            Reporter.log("Test_16 : Verify Instructor is able to set and Clear Due Date from Date Manager ",true); 
        ...
        @Test
        public void TestStep_17_verifyInstructorLaunchesSearchAppFromAppsMenu(){
            Reporter.log("Test_17 : Verify Instructor is able to Launch Search App ",true);
        ...
        @Test
        public void TestStep_18_verifyInstructorLaunchesStudyCenterAppFromAppsMenu(){
            Reporter.log("Test_18 : Verify Instructor is able to Launch Study Center App ",true);
        ...
        @Test
        public void TestStep_19_verifyInstructorLaunchesMessageCenterAppFromAppsMenu(){
            Reporter.log("Test_19 : Verify Instructor is able to Launch Message Center App ",true);
        ...
        @Test
        public void TestStep_20_verifyInstructorLaunchesProgressAppFromAppsMenu(){
            Reporter.log("Test_20 : Verify Instructor is able to Launch Progress App ",true);
        ...
        @Test
        public void TestStep_21_verifyInstructorLaunchesFlashcardsAppFromAppsMenu(){
            Reporter.log("Test_21 : Verify Instructor is able to Launch Flashcards App ",true);
        ...
        @Test
        public void TestStep_22_verifyInstructorLaunchesGlossaryAppFromAppsMenu(){
            Reporter.log("Test_22 : Verify Instructor is able to Launch Glossary App ",true);
        ...
        @Test
        public void TestStep_23_verifyInstructorLaunchesFullbookAppFromAppsMenu(){
            Reporter.log("Test_23 : Verify Instructor is able to Launch Fullbook App ",true);
        ...
        @Test
        public void TestStep_24_verifyInstructorLaunchesMerriamWebsterDictionaryAppFromAppsMenu(){
            Reporter.log("Test_24: Verify Instructor is able to Launch Merriam Webster Dictionary App ",true);
        ...
        @Test
        public void TestStep_25_verifyInstructorLogoutFromMTXHistoryCourse(){
            Reporter.log("Test_25 : Verify Instructor is able to Log Out from MTX History  ",true);
            test.MTXDashBoardPage.verifyLogOutFromMTXCourse();
            Reporter.log("Instructor has successfully Logged Out from MTX History Course",true);
