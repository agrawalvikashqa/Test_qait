 ...
 */
package com.cengage.mtx.tests.History.Mindapps.RssFeed;
...
public class TC01_RssFeedAppTest {
   ...
   @Test
    public void TestStep_02_LaunchAppFromAppDock() {
        Reporter.log("Test_02 : Verify Instructor Launch App from App Dock",true);
    ...
    public void TestStep_03_addRssFeed() {
        ...
        Reporter.log(user+"successfully adds Rss Feed",true); 
    ...
    public void TestStep_04_clickOnAddActivityIcon() {
        ...
        Reporter.log(user+"successfully Instructor add Activity Icon",true); 
    }
    

   @Test
    public void TestStep_05_AddRSSActivityToLPN() {
        Reporter.log("Test_05 : Verify Add RSS Activity To LPN",true);
    ...
    public void TestStep_06_VerifyAddedRssActivityToLPN() {
        ...
        Reporter.log(user+"successfully Verified Added Rss Activity To LPN",true); 
       }

    @Test
    public void TestStep_07_DeleteAddedRssActivityToLPN() {
        Reporter.log("Test_07 : Verify Instructor Delete Added Rss Activity To LPN ",true);
