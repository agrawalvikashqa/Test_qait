 ...
 * @author chandanjyot
 */
public class TC_03_InstructorDeleteChallengesActivityTest {
	 ...
	 */
        ...
        test = new TestSessionInitiator("InstructorDeleteChallengesActivityTest");
    ...
    public void TestStep_02_InstructorDeleteTakeofActivity(){
        ...
        test.MTXNarrativePage.clickOnActivityLinkInGradebook(ChemistryReviewActivity);
