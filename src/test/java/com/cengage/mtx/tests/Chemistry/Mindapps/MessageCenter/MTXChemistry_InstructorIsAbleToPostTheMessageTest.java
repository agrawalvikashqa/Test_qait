 ...
 * @author QAI
 */
public class MTXChemistry_InstructorIsAbleToPostTheMessageTest {
    ...
    public void start_test_session() {
        test = new TestSessionInitiator("Instructor Is Able To Post The Message Test : JIRA Story ID: https://jira.cengage.com/browse/NG-27384");
