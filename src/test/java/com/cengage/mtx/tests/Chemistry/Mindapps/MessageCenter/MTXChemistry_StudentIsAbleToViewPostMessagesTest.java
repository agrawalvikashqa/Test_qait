 ...
 */
package com.cengage.mtx.tests.Chemistry.Mindapps.MessageCenter;
 ...
 * @author QAI
 */
public class MTXChemistry_StudentIsAbleToViewPostMessagesTest {
    ...
    public void start_test_session() {
        ...
        test = new TestSessionInitiator("Student Is Able To View Post Messages Test : JIRA Story ID: https://jira.cengage.com/browse/NG-27384");
