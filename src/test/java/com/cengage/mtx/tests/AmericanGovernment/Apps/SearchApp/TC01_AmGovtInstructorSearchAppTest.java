 ...
 */
package com.cengage.mtx.tests.AmericanGovernment.Apps.SearchApp;


import com.cengage.mtx.tests.History.Apps.SearchApp.*;
 ...
 * @author QAI
 */
public class TC01_AmGovtInstructorSearchAppTest {
    
    TestSessionInitiator test;
    
    
    String user;
    String amGovSearchTerm = getData("Books.AmGovtSearchApp.amGovSearchTerm");
    ...
    @BeforeClass
        ...
        test = new TestSessionInitiator("American Government Instructor Search App Test");
    ...
    void TestStep_02_searchForBodyText(){
        ...
        test.MTXSearchPage.selectSearchByTerm(amGovSearchTerm);
