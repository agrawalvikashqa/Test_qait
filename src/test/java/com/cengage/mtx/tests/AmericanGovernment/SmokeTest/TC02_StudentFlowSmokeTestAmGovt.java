 ...
 * @author Kashyap
 */
public class TC02_StudentFlowSmokeTestAmGovt {
	...
	public void TestStep_11_verifyStudentNavigatesToUnitViewAndLaunchesUnit(){
        ...
        @Test
	public void TestStep_12_verifyStudentLaunchesActivityTypeConnectingWithPolitics(){
           Reporter.log("Test_12 : Verify Student Launches Activity Type Connecting With Politics ",true); 
           ...
           Reporter.log("Verified that Student Successfully Launches and close Activity Type Connecting With Politics",true);
	...
	public void TestStep_13_verifyStudentLaunchesActivityTypeConceptualNarrative(){
        ...
        @Test
	public void TestStep_14_verifyStudentLaunchesActivityTypeDiscussionBoard(){
           Reporter.log("Test_14 : Verify Student Launches Activity Type Discussion Board",true); 
           test.MTXDashBoardPage.verifyLaunchDiscussionBoard();           
           test.MTXFramePage.switchToDBoardFrame();
           //test.MTXFramePage.switchToActivityOverviewFrame();
           test.MTXActivityPage.overviewContinueActivityButton();           
           test.MTXActivityPage.verifyDiscussionBoardTips();
           test.MTXFramePage.switchToDefaultContent();
           test.MTXActivityPage.closeActivity();
           Reporter.log("Verified that Student Successfully Launches and closes Activity Type Discussion Board ",true);          
        }
        
        @Test
	public void TestStep_15_verifyStudentLaunchesActivityTypeContextualLens(){
           Reporter.log("Test_15 : Verify Student Launches Activity Type Contextual Lens",true); 
        ...
        @Test
	public void TestStep_16_verifyStudentLaunchesActivityTypeEssay(){
           Reporter.log("Test_16 : Verify Student Launches Activity Type Essay",true); 
        ...
        @Test
	public void TestStep_17_verifyStudentLaunchesStudyGuide(){
           Reporter.log("Test_17 : Verify Student Launches Study Guide ",true); 
        ...
        @Test
        public void TestStep_18_verifyStudentLaunchesSearchAppFromAppsMenu(){
            Reporter.log("Test_18 : Verify Student is able to Launch Search App ",true);
        ...
        @Test
        public void TestStep_19_verifyStudentLaunchesStudyCenterAppFromAppsMenu(){
            Reporter.log("Test_19 : Verify Student is able to Launch Study Center App ",true);
        ...
        @Test
        public void TestStep_20_verifyStudentLaunchesMessageCenterAppFromAppsMenu(){
            Reporter.log("Test_20 : Verify Student is able to Launch Message Center App ",true);
        ...
        @Test
        public void TestStep_21_verifyStudentLaunchesProgressAppFromAppsMenu(){
            Reporter.log("Test_21 : Verify Student is able to Launch Progress App ",true);
        ...
        @Test
        public void TestStep_22_verifyStudentLaunchesFlashcardsAppFromAppsMenu(){
            Reporter.log("Test_22 : Verify Student is able to Launch Flashcards App ",true);
        ...
        @Test
        public void TestStep_23_verifyStudentLaunchesGlossaryAppFromAppsMenu(){
            Reporter.log("Test_23 : Verify Student is able to Launch Glossary App ",true);
        ...
        @Test
        public void TestStep_24_verifyStudentLaunchesPollingAppFromAppsMenu(){
            Reporter.log("Test_24 : Verify Student is able to Launch Polling App ",true);
            test.DashBoardPage.clickOnAppByName("Polling");
            test.MTXFramePage.switchToDockIFrame(PollingTitle);
            test.MTXDashBoardPage.verifyPollingAppLaunchStudent();
        ...
        @Test
        public void TestStep_25_verifyStudentLaunchesFullbookAppFromAppsMenu(){
            Reporter.log("Test_25 : Verify Student is able to Launch Fullbook App ",true);
        ...
        @Test
        public void TestStep_26_verifyStudentLaunchesMerriamWebsterDictionaryAppFromAppsMenu(){
            Reporter.log("Test_26 : Verify Student is able to Launch Merriam Webster Dictionary App ",true);
        ...
        @Test
        public void TestStep_27_verifyStudentLogoutFromMTXAmGovtCourse(){
            Reporter.log("Test_27 : Verify Student is able to Log Out from MTX American Government  ",true);
