 ...
 */
package com.cengage.mtx.tests.AmericanGovernment.Mindapps.MessageCenter;
 ...
 * @author QAI
 */
public class MTXAmGovt_StudentIsAbleToViewPostMessagesTest {
    ...
    public void start_test_session() {
        ...
        test = new TestSessionInitiator("Student Is Able To View Post Messages Test : JIRA Story ID: https://jira.cengage.com/browse/NG-27331");
    ...
    */
   @Test
    public void TestStep_02_viewPostedMessages() {
    ...
    */
   @Test
    public void TestStep_03_viewUrgentPostedMessages() {
